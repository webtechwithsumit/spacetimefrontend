  ...
  return (
    ...
    >
      <div className="relative w-full overflow-x-auto">
        ...
        <ol
          className="relative grid min-w-[32rem] sm:min-w-0"
          ...
          {steps.map((item) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span
                    className={`relative z-10 flex size-6 shrink-0 items-center justify-center rounded-full text-[11px] font-semibold transition-colors ${
                      isActive
